...
images = ["images_binaires/alfa2.bmp", "images_binaires/beee2.bmp", "images_binaires/cible2.bmp", "images_binaires/city2.bmp",
          "images_binaires/country2.bmp", "images_binaires/promenade2.bmp", "images_binaires/veau2.bmp", "images_binaires/zebre2.bmp"]
...
for n_image in images:
    ...
    for n_bruit in range(1, 6):
        ...
        taux_erreur_moy_gauss = moyenne(erreur_moyenne_gauss(T, X, cl1, cl2, m1, sig1, m2, sig2))
        print("taux d'erreur moyen gaussien : ", taux_erreur_moy_gauss)

        taux_erreur_moy_MAP = moyenne(erreur_moyenne_MAP(T, X, cl1, cl2, m1, sig1, m2, sig2))
        print("taux d'erreur moyen critère MAP : ", taux_erreur_moy_MAP)

        taux_erreur_moy_BW = moyenne(erreur_moyenne_BW(T, X, cl1, cl2, m1, sig1, m2, sig2, p10, p20))
        print("taux d'erreur moyen algo BW: ", taux_erreur_moy_BW)
        print()
